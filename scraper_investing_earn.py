...
investing = "https://www.investing.com/earnings-calendar//"
...
#write data to csv
with open ('D:\\Safe_IKF\\IKF_DimaN\\Projects\\Web_data_scrapers\\Output_files\\investing_com-earn-'+date+'.csv','w',newline='') as fp:
